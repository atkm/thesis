...
\begin{theorem}
  ...
  If $G: Y\to Y$ is conjugate to $F$ i.e. $\phi \circ F = G \circ \phi$, where $\phi$ is a homeomorphism, then $G$ is chaotic.
  \begin{proof}
  ...
  \begin{equation*}
    \lim\limits_{n \to \infty}\; d_{G_n} = 0.
  \end{equation*}
  Then, for each $\delta$, there are infinitely many $n$ such that 
  \begin{equation*}
    (\phi^{-1} \circ G^n)(\phi(p)) \in \oball{\delta}{(\phi^{-1} \circ G^n)(\phi(p))}.
  \end{equation*}
  In particular, there is $0 < \delta_0 < b$.
