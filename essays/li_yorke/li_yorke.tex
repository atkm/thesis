...
There are mappings that are chaotic on a negligible set \citep{martelli}.
\begin{example}
...
Not only the Henon map \citep{marotto1} and some type of wave equation have been shown to be chaotic in Marotto's sense, (Chaotic vibration of the one-dimensional linear wave equation with a van der Pol nonlinear boundary condition) \citep{marottoapp1},
the definition has been successfully applied to models in population biology \citep{marottoapp2} and neuroscience \citep{marottoapp3}.
