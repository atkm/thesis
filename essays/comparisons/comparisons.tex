...
\begin{example}
  ...
  For $(\bar{X}, \sigma)$ to be a well-defined dynamical system, we need $\bar{X}$ to be invariant under $\sigma$ \citep[p.179]{lind}.
  ...
  For the system to be chaotic in Wiggins's sense, $\sigma$ needs to be sensitive to initial conditions on $\bar{X}$, as well.
  ...
  Note that, $\sigma$ cannot have dense periodic points in $\bar{X}$; hence, the system is not chaotic in Devaney's sense.
