...
However, the three definition that are equivalent for a compact interval are no longer equivalent in a general compact metric space (Figure~\ref{fig:chaos-metric}).
