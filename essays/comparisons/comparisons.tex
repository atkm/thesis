...
\end{equation*}
  ...
  (Incorrect.. $\phi$ isn't continuous at $0 \in S^1$. Need to do something about it.)
  ...
  For the system to be chaotic in Wiggins's sense, $\sigma$ needs to be sensitive to initial conditions.
  Let $0 < \delta < 1$ be our separation constant.
  
  Clearly, for each $x,y \in \Sigma$, there are infinitely many $n$ such that 
  \begin{equation*}
