...
\begin{theorem}
  ...
  \begin{proof}
    That $F$ is semi-conjugate to $\sigma: \Sigma \to \Sigma$ implies $h(\sigma) \leq h(F)$.
...
\subsubsection*{Block-Coppel and Li-Yorke}
\blcp implies \pte, and \pte implies \liy; hence, the implication from \blcp to \liy is induced.
...
\subsubsection*{Result}
As in the compact interval case, \dev, \blcp, and \pte imply \liy.
However, the three definition that are equivalent for a compact inteval are not equivalent in a more general case.
