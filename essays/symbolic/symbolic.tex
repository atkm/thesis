...
We have an example of coding in Chapter~\ref{chap:comparisons} (Example~\ref{eg:blanchard}), although the purpose is not to study a dynamical system, but to construct a system with desired properties.
...
The hope is that we can gain better understanding of higher-dimensional systems by studying behaviors in one-dimensional system.
...
It is not at all obvious whether this definition serves as a definition of chaos in non-one-dimensional systems.
...
We mentioned in the introduction that the fractal dimension is sometimes regarded as a signature of chaos.
