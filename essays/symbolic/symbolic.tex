...
The key to construct a conjugacy between $(S^1,D)$ and $(\Sigma, \sigma)$ is to think of an infinite sequence in $\Sigma$ as the binary expansion of some real number.
...
\begin{proposition}
  The doubling map on the unit circle is conjugate to the full one-sided shift.
  \begin{proof}
  \end{proof}
\end{proposition}
%%%
